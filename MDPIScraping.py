...
def scrapping():
    ...
    i = 0
    driver.get("https://www.mdpi.com/search?q=&authors=&journal=forests&article_type=research-article&search=Search&section=&special_issue=&volume=&issue=&number=&page=")
    print(0)
...
#     #print("free full article link clicked.")
    ...
    pageNum = 15    # The number of pages to be scraped
    ...
    for i in range(pageNum):
        ...
        rawTitles = driver.find_elements_by_xpath("//div/a[@class='title-link']")
        print(len(rawTitles))
    ...
    #             print(3)
        ...
        #                 driver1.get(actualDownloadUrl)
                    ...
                    if "Download PDF" in driver1.page_source:
                        ...
                        downloadNode = driver1.find_elements_by_xpath("//a[@class = 'button button--color-inversed margin-bottom-10 UD_ArticlePDF']")[0]
        ...
        if (i+1) < pageNum:
            ...
            nextPage = driver.find_elements_by_xpath("//span[@class = 'pageSelect']/a")[-2]
            if nextPage:
